...
module.exports = class PublisherVideo {
    ...
    constructor (args = {}) {
        ...
        this.dashDuration = args.dashDuration || 4000
        ...
        this.workPath = '/home/warncke/ciph/ciph-core/.1521492271374-26963-ciph'
    }
    ...
    async createContainer () {
        ...
        for (const sourceName in this.containerFiles.mediaFiles) {
            ...
            await this.container.addFileGroup(files.slice(0, 2), blockSize.size)
        }
