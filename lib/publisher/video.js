...
module.exports = class PublisherVideo {
    ...
    async prepareSources () {
        ...
        console.log(this.sources.audio)
        console.log(this.sources.subtitle)
        console.log(this.sources.video)

            // demux video to working directory
            // await FFMPEG.demuxVideo(file.path, video.index, videoMeta.file.path)

            // console.log(videoMeta, videoFileName)
    }
}