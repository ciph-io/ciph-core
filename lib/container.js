    ...
    getInfo () {
        ...
        return {
            ...
            links: {
                ...
                web: {
                    open: `${this.api}/enter?ciph=${this.publicId}#${openLink.join('-')}`,
                    secure: `${this.api}/enter?ciph=${this.publicId}#${secureLink.join('-')}`,
                }
            },
